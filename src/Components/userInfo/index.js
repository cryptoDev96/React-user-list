...
class UserInfo extends React.Component {
    ...
    closeCard = (uuid, show) => {
        this.props.parentCallback(uuid,show);
    }
    ...
    render() {
        ...
        return (
            <div className='card'>
                <svg viewBox="0 0 24 24" focusable="false" onClick={() => this.closeCard(login.uuid, false)}
                ...
                <button className='chakra-button userBtn' onClick={() => this.closeCard(login.uuid, true)}>Connect</button>
            </div>
        )
    }
}
